...
RADJUST
  my $colorValues = "c(\"WHO Standards, +2SD\" = \"red\",\"WHO Standards, -2SD\" = \"red\",\"WHO Standards, Mean\" = \"black\",\"Recumbent length (cm)\" = \"blue\", \"Weight (kg)\" = \"blue\", \"Length-for-age z-score\" = \"#56B4E9\", \"Weight-for-age z-score\" = \"#CC79A7\", \"Weight-for-length z-score\" = \"#0072B2\", \"Day in diarrheal episode\" = \"#000099\", \"Adenovirus, by ELISA\" = \"#440154FF\", \"Aeromonas, by bacteriology\" = \"#460B5EFF\", \"Hookworm, by microscopy\" = \"#481668FF\", \"Ascaris lumbricoides, by microscopy\" = \"#481E70FF\", \"Astrovirus, by ELISA\" = \"#482778FF\", \"Balantidium coli, by microscopy\" = \"#472F7EFF\", \"Campylobacter, by ELISA\" = \"#453882FF\", \"Chilomastix mesnili, by microscopy\" = \"#424086FF\", \"Cryptosporidium, by ELISA\" = \"#3F4889FF\", \"Cyclospora, by microscopy\" = \"#3C508BFF\", \"Endolimax nana, by microscopy\" = \"#38588CFF\", \"Entamoeba coli, by microscopy\" = \"#355F8DFF\", \"Entamoeba histolytica, by ELISA\" = \"#31668EFF\", \"Enterobius vermicularis, by microscopy\" = \"#2E6D8EFF\", \"Atypical EPEC, by PCR\" = \"#2C738EFF\", \"EAEC aatA-pos or aaiC-pos, by PCR\" = \"#29798EFF\", \"EIEC ipaH-pos, by PCR\" = \"#27808EFF\", \"EPEC eae-pos and bfpA-pos, by PCR\" = \"#24868EFF\", \"ETEC LT-pos ST-neg, by PCR\" = \"#228D8DFF\", \"ETEC ST-pos, by PCR\" = \"#20938CFF\", \"STEC stx1-pos or stx2-pos, by PCR\" = \"#1F9A8AFF\", \"Giardia, by ELISA\" = \"#1FA188FF\", \"Hymenolepis diminuta, by microscopy\" = \"#22A785FF\", \"Hymenolepis nana, by microscopy\" = \"#27AD81FF\", \"Iodamoeba butschlii, by microscopy\" = \"#2EB37CFF\", \"Isospora, by microscopy\" = \"#39B977FF\", \"Norovirus GI, by qRT-PCR\" = \"#44BF70FF\", \"Norovirus GII, by qRT-PCR\" = \"#52C569FF\", \"Plesiomonas shigelloides, by bacteriology\" = \"#60CA60FF\", \"Rotavirus (post-vax corrected), by ELISA\" = \"#70CF57FF\", \"Salmonella, by bacteriology\" = \"#80D34DFF\", \"Schistosoma, by microscopy\" = \"#92D742FF\", \"Shigella, by bacteriology\" = \"#A3DB36FF\", \"Strongyloides stercoralis, by microscopy\" = \"#B6DE2AFF\", \"Taenia, by microscopy\" = \"#C9E020FF\", \"Trichuris trichiura, by microscopy\" = \"#DBE319FF\", \"Vibrio, by bacteriology\" = \"#ECE51BFF\", \"Yersinia enterocolitica, by bacteriology\" = \"#FDE725FF\")";
