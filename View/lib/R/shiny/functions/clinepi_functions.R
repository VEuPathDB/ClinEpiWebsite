  ...
  if (queryName == "Participant") {
    ...
    if (timeSourceId == "none") {
      ...
      query <- paste0("with termtime as (",
                       " select c1.community_id",
                             ", c1.string_value as ", sourceId,
                             ", c2.string_value as ", timeSourceId,
                       " from apidbTuning.", tblPrefix, "CommunityMD c1",
                           ", apidbTuning.", tblPrefix, "CommunityMD c2",
                       " where c1.ontology_term_name = '", sourceId, "'",
                       " and c2.ontology_term_name = '", timeSourceId, "'",
                       " and c1.community_id = c2.community_id",
                       " and exists (select ontology_term_name",
                                   " from apidbTuning.", tblPrefix, "CommunityMD",
                                   " where ontology_term_name = '", sourceId, "'",
                                   " and community_id = community_observation_id)",
                       " UNION ALL",
                       " select c1.community_id",
                             ", c1.string_value as ", sourceId,
                             ", c2.string_value as ", timeSourceId,
                       ...
                       " where c1.ontology_term_name = '", sourceId, "'",
                       " and c2.ontology_term_name = '", timeSourceId, "'",
                       " and c1.community_observation_id = c2.community_observation_id",
