help <- tabPanel("Help", fluid = TRUE,
          fluidPage(
            ...
            h5(
              ...
              p(" In the second table below the drop-down boxes to select your variables, you can see the numbers within the table indicate the number of participants that meet the defined criteria.
For example, the value in the top left corner of this table represents the number of participants for which both of your selected variables are positive/true. 
Meanwhile, the value in the bottom right corner represents the number of participants negative for both variables."),
