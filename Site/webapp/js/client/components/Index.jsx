    ...
    <div className="Welcome">
      ...
      <div className="SearchContainer">
        <a
          ...
          href={`${webAppUrl}/showQuestion.do?questionFullName=ParticipantQuestions.ParticipantsByRelativeVisits`}
        >
        ...
        <a
          ...
          href={`${webAppUrl}/showQuestion.do?questionFullName=DwellingQuestions.DwellingsByCharacteristics`}
        >
        ...
        <a
          ...
          href={`${webAppUrl}/showQuestion.do?questionFullName=ClinicalVisitQuestions.ClinicalVisitsByRelativeVisits`}
        >
        ...
        <a
          ...
          href={`${webAppUrl}/showQuestion.do?questionFullName=LighttrapQuestions.CollectionsByCharacteristics`}
        >
        ...
        <div className="ExploreSection">
          ...
          <div>
            <ul>
              ...
              <li>
                <a href={`${webAppUrl}/im.do?s=efd94f0039d4f88f`}>
